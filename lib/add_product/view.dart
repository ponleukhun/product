...
import 'package:product/all_product/logic.dart';
...
class _AddProductPageState extends State<AddProductPage> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AddProductLogic>(builder: (logic) {
      return Scaffold(
          body: Column(
        children: [
          Container(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                      ...
                      return Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? newValue) {
                            if (newValue != null) {
                              state.selectedCategory.value = newValue;
                            }
                          },
                    ...
                    //           ? state
                    //               .dataDropdown.firstOrNull // Ensure value exists
                    //           : state.selectedCategory.value,
                    //       icon: const Icon(
                    //         Icons.arrow_drop_down,
                    //         size: 35,
